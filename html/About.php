        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="Restaurant.html.php" style="color: darkgoldenrod;font-family: 'Times New Roman', Times,serif">RESTAURANT</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="Book Now.html.php" style="color: darkgoldenrod;font-family: 'Times New Roman', Times,serif">BOOK NOW</a>
              </li>
              <li class="nav-item">
